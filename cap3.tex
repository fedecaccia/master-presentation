...
\centering
\subfloat{\includegraphics[scale=0.4]{net_linear_its.pdf}}\\
\subfloat{\includegraphics[scale=0.4]{net_linear_fevals.pdf}}
\end{minipage}\hfill
\begin{minipage}{.5\linewidth}
\centering
\subfloat{\includegraphics[scale=0.45]{net_linear_its_broy.pdf}}
\end{minipage}
\end{figure}
\end{frame}
